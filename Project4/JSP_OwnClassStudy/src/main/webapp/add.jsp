...
<form
  ...
  <div class="mb-3" id="my-mb-3-1">
    ...
    <input type="number" class="form-control" name="week" placeholder="Ex : 1주차" id = "data3">
  </div>
  <div class="mb-3" id="my-mb-3-2">
    <label for="data4" class="form-label">차시</label>
    <input type="number" class="form-control" name="count" placeholder="Ex : 1차시" id = "data4">
  </div>
  <div class="mb-3">
    <label for="data5" class="form-label">제목</label>
    <input type="text" class="form-control" name="title" placeholder="Ex : 수업 정리" id = "data5">
  </div>
  <div class="mb-3">
    <label for="data6" class="form-label">내용</label>
    <textarea class="form-control" id="data6" rows="3" name="content" id = "data6"></textarea>
  </div>
